...
3. Execute `make clean` to generate the source code for all the PRINTF statements

### Switch Between Target Builds

This section needs revision!

Old: to switch between NanoS and NanoX builds, you have to
...
The txnTypesList.c source file is autogenerated by the createTxnTypes.py script from the txtypes.txt file.
...
If you are compiling for the first time or making a change to the list of transaction types
