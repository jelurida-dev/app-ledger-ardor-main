...
def test_send_ignis_blind_reject(backend, navigator, device):
    tx_bytes = ""
    if device.is_nano:
...
def test_send_ignis_blind_reject_tx(backend, navigator, device):
    tx_bytes = ""
    if device.is_nano:
        enable_blind_signing(navigator)
...
def test_ardor_coin_exchange(backend, navigator, device):
...
def test_coin_exchange(backend, navigator, device):
...
def test_asset_transfer(backend, navigator, device):
    ...
    instructions = get_accept_instructions(device, num_taps=3, num_screens=6)
    _sign_tx_test(backend, navigator, tx_bytes, expected_signature, "test_asset_transfer", instructions)

def test_send_ignis_4_attachments(backend, navigator, device):
...
def test_send_ignis_referenced_tx(backend, navigator, device):
...
def test_place_asset_exchange_order(backend, navigator, device):
