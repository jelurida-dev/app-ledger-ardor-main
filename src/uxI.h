...
//Added for text scroll
#define UI_NANOS_TEXT_SCROLL(userid, x, y, w, text) {{BAGL_LABELINE,userid,x,y,w,12,0x80|10,0,0,0xFFFFFF,0,BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER,26},(char *)text,0,0,0,NULL,NULL,NULL}
